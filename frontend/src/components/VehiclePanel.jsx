    ...
    return (
        <div>
            ...
            <div className='fare-details'>
                <h4 className='font-medium text-base'>Optimized Path</h4>
                <p>Distance: {props.fare.distance}</p>
                <p>Duration: {props.fare.duration}</p>
                <p>Toll: ₹{props.fare.toll}</p>
                <p>Fuel Cost: ₹{props.fare.fuelCost}</p>
                <p>Total Cost: ₹{props.fare.totalCost}</p>
            </div>
        </div>
    )
}
